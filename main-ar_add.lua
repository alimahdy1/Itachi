...
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/dndjsjssj/Ggg/refs/heads/main/Ggs"))()
...
local SkybaseTab = Window:MakeTab({
    Name = "الجوي",
    Icon = "rbxassetid://112",
    PremiumOnly = false
})
...
local LostChildrenTab = Window:MakeTab({
    Name = "الاطفال",
    Icon = "rbxassetid://112",
    PremiumOnly = false
})
...
InfoTab:AddLabel("📖 يرجى القراءة قبل الاستخدام:")
InfoTab:AddLabel("🔥 إعداد النار:")
InfoTab:AddLabel("تأكد من ترقية نارك إلى أقصى مستوى.")
InfoTab:AddLabel("قد تتعطل العناصر إذا قمت بنقلها من مناطق خريطة")
InfoTab:AddLabel("غير مفتوحة إلى موقعك.")
InfoTab:AddLabel("🎯 خيارات النقل:")
InfoTab:AddLabel("كل ميزة نقل لها خيارين للوجهة:")
InfoTab:AddLabel("• اللاعب: ينقل العناصر إلى موقعك")
InfoTab:AddLabel("• نار المخيم/المجمع: ينقل إلى المحطة المحددة")
InfoTab:AddLabel("اختر الخيار الذي يناسبك أكثر!")
InfoTab:AddLabel("🐛 وجدت مشاكل أو لديك أفكار؟")
InfoTab:AddLabel("انضم إلى مجتمع الديسكورد! يمكنك العثور على الرابط")
InfoTab:AddLabel("في قسم الائتمانات أعلاه.")
InfoTab:AddLabel("نرحب بتقارير الأخطاء واقتراحات الميزات!")
...
MiscTab:AddLabel("بعد إيقاف تشغيله تأكد من زيارة نار المخيم لإعادة تشغيل الإضاءة الحقيقية")
...
-- قسم معزز الأداء
MiscTab:AddLabel("⚡ معزز الأداء - يرجى ملاحظة: بمجرد تفعيله، للتعطيل يجب إعادة تشغيل اللعبة/الخادم")
...
MiscTab:AddLabel("🗺️ كشف الخريطة - يرجى التأكد من تطوير نار المخيم إلى الحد الأقصى أولاً، سيكون أفضل بكثير")
...
local FirearmSection = CombatTab:AddSection("خيارات الأسلحة النارية")
...
CampfireTab:AddLabel("🚀 يستخدم نظام نقل متقدم")
CampfireTab:AddLabel("🎯 35 متر لأعلى، 5 أمتار للخلف للإسقاط المثالي")
...
for _, chestType in pairs(ChestTypes) do
    ChestDropdowns[chestType] = ChestsTab:AddDropdown({
...
SkybaseTab:AddLabel("للحصول على أقصى فائدة، ابنِ قاعدة في السماء")
SkybaseTab:AddLabel("ثم أحضر حقول المحاصيل، حاول الحصول على كمية كبيرة وضعها كلها على القاعدة")
SkybaseTab:AddLabel("🍎 فعّل ميزة الأكل الذكي واضبط الجوع على 100-150 حسب تفضيلك")
SkybaseTab:AddLabel("ثم اذهب إلى سريرك وانم بهدوء 😴")
SkybaseTab:AddLabel("❤️ لعب سعيد!")

-- أدوات التحكم في الأطفال المفقودين
LostChildrenToggle = LostChildrenTab:AddToggle({
...
LostChildrenStatus = LostChildrenTab:AddLabel("الحالة: غير نشط")

LostChildrenTab:AddLabel("ℹ️ كيف يعمل:")
LostChildrenTab:AddLabel("• تأكد من أن النار في أقصى مستوى")
LostChildrenTab:AddLabel("• تأكد من أن الكيس به 4 مساحات فارغة")
LostChildrenTab:AddLabel("• لا تقلق إذا بدأ يتحرك وحده، إنه يبحث عنهم")
LostChildrenTab:AddLabel("• بعد جمع جميع الأطفال، سيعود إلى موقعك")
...
CreditsTab:AddLabel("المطور: Toasty")
CreditsTab:AddLabel("شكراً لاستخدام هذا الاسكربت!")
...
CreditsTab:AddLabel("وجدت خطأ أو لديك اقتراحات؟")
CreditsTab:AddLabel("لا تتردد في الإبلاغ عنها في الديسكورد!")
CreditsTab:AddLabel("💡 استخدم النقل إلى: اللاعب إذا تعطل المجمع")
